    ...
    <div class="row">
        <div class="col-md-6">
            <h1>Bonjour <?= $user['pseudo_utilisateur']; ?>
                <br> </h1>
            <p>Bienvenue sur votre profil ! <br/> Vous pouvez le personnalisé si vous le voulez !</p>
            <br><br>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            while($row = $req->fetch()) {  ?>
                ...
                <img class="img-circle" src="../membres/avatar/<?= $row['img_utilisateur']; ?>" width="200px" height="200px" class="img-responsive" />
